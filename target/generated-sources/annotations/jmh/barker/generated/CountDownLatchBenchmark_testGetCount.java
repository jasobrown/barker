...
public final class CountDownLatchBenchmark_testGetCount {
    ...
    public Collection<? extends Result> testGetCount_Throughput(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            ...
            testGetCount_Throughput_measurementLoop(control, res, l_countdownlatchbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "testGetCount", res.getOperations(), res.getTime(), tu));
            return results;
        } else
    ...
    public void testGetCount_Throughput_measurementLoop(InfraControl control, RawResults result, CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> testGetCount_AverageTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0 = _jmh_tryInit_f_countdownlatchbenchmark0_0(control);
            ...
            RawResults res = new RawResults(1L);
            testGetCount_AverageTime_measurementLoop(control, res, l_countdownlatchbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_countdownlatchbenchmark0_0.testGetCount());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "testGetCount", res.getOperations(), res.getTime(), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void testGetCount_AverageTime_measurementLoop(InfraControl control, RawResults result, CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> testGetCount_SampleTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0 = _jmh_tryInit_f_countdownlatchbenchmark0_0(control);
            ...
            testGetCount_SampleTime_measurementLoop(control, buffer, targetSamples, l_countdownlatchbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_countdownlatchbenchmark0_0.testGetCount());
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "testGetCount", buffer, tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public void testGetCount_SampleTime_measurementLoop(InfraControl control, SampleBuffer buffer, int targetSamples, CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0, BlackHole_1_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    @CompilerControl(CompilerControl.Mode.DONT_INLINE)
    public Collection<? extends Result> testGetCount_SingleShotTime(InfraControl control, ThreadControl threadControl) throws Throwable {
        long realTime = 0;
        if (threadControl.subgroup == 0) {
            BlackHole_1_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control);
            CountDownLatchBenchmark_1_jmh l_countdownlatchbenchmark0_0 = _jmh_tryInit_f_countdownlatchbenchmark0_0(control);
            ...
            Collection<Result> results = new ArrayList<Result>();
            TimeUnit tu = (control.timeUnit != null) ? control.timeUnit : TimeUnit.MICROSECONDS;
            results.add(new SingleShotResult(ResultRole.PRIMARY, "testGetCount", (realTime > 0) ? realTime : (time2 - time1), tu));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }
